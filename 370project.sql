...
INSERT INTO `employee_leave` (`id`, `token`, `start`, `end`, `reason`,`Remark`, `status`) VALUES
...
-- Indexes for table 'daily_updates'
  ...
  ADD KEY `daily_updates_ibfk_1` (`id`);
...
--
ALTER TABLE `daily_updates`
ADD CONSTRAINT `daily_updates_ibfk_1` FOREIGN KEY (`id`) REFERENCES `employee` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
