<?php 
	...
	$sql4 = "Select *from employee, daily_updates Where employee.id = $id and daily_updates.id = $id order by daily_updates.token";
...
<html>
<head>
	<title>Employee Panel | SR Automations</title>
...
<body>
	...
	<header>
		<nav>
			...
			<ul id="navli">
				...
				<li><a class="homeblack" href="applyleave.php?id=<?php echo $id?>"">Weekly Report</a></li>
	...
	<div>
		...
		<h2 style="font-family: 'Montserrat', sans-serif; font-size: 25px; text-align: center;">daily updates</h2>
		...
		<h2 style="font-family: 'Montserrat', sans-serif; font-size: 25px; text-align: center;">Weeklys Updates</h2>
