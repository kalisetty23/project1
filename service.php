...
<html>
<head>
	<title>Service | Employee Panel | SR Automations</title>
	...
	<header>
		<nav>
			...
			<ul id="navli">
                ...
                <li><a class="homeblack" href="service.php?id=<?php echo $id?>"">service</a></li>
                ...
                <div class="card-body">
                    ...
                    <form action="process/dailyupdatesprocess.php?id=<?php echo $id?>" method="POST">
					    ...
					    <div class="input-group">
                            <input class="input--style-1" type="textarea" placeholder="Application Name" name="application_name" rows="2" cols="70">
						</div>
                        ...
                        <div class="input-group">
						<label for="input--style-1">Problem</label>
						<textarea class="input--style-1" name="w3review" rows="2" cols="70">
  
 							 </textarea> </div>
							  <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Reference Person" name="reference_person">
						</div>
						<div class="input-group">
						<label for="input--style-1">Existing FA Products Details</label>
						<textarea class="input--style-1" name="w3review" rows="2" cols="70">
  
 							 </textarea> </div>
							  <div class="input-group">
						<label for="input--style-1">Observation</label>
						<textarea class="input--style-1" name="w3review" rows="2" cols="70">
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="work status" name="work_status">
                        </div>
						...
						<div class="input-group">
                            <input class="input--style-1" type="file" placeholder="myfile" name="file_name">
                        </div>
